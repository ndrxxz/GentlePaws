        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-black text-white">
                    <h4 class="fw-bold pt-3">Pending Appointments</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-3 py-1">
                                            <div class="button-group">
                                                <a href="approved.php?id=<?= $bookings['id']; ?>" class="btn btn-success btn-sm approved"><span><i class="bi bi-hand-thumbs-up-fill"></i></span></a>
                                                <a href="rejected.php?id=<?= $bookings['id']; ?>" class="btn btn-warning btn-sm rejected"><span><i class="bi bi-hand-thumbs-down-fill"></i></span></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php 
...
<script>
    $(document).ready(function(){
        $('.approved').on('click', function(e) {
            ...
            Swal.fire({
                title : 'Are you sure?',
                text : 'You want to approved this appointment?',
                icon: 'warning',
...
<script>
    $(document).ready(function(){
        $('.rejected').on('click', function(e) {
            ...
            Swal.fire({
                title : 'Are you sure?',
                text : 'You want to decline this appointment?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
