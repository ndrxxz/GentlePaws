...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO close (date) VALUES ('$date')";
    ...
    if(!$query_run){
        ...
        $_SESSION['message'] = "Adding Date Successful";
        header("Location: close.php");
        exit(0);
    }
}
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-black text-white">
                    <h4 class="fw-bold pt-3">Close Dates
                    <button type="button" class="btn btn-primary float-end book" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Date</button>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <table id="myTable" class="table-bordered table-striped w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-5 py-1 text-center">Date</th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(mysqli_num_rows($query_run) > 0){
                                        foreach($query_run as $close){
                                ?>
                                <tr>
                                    <td class="px-1 text-center"><?= $close['id']; ?></td>
                                    <td class="px-1 text-center"><?= $close['date']; ?></td>
                                    <td class="px-3 py-2">
                                        <button class="btn btn-success btn-sm edit"><span><i class="bi bi-pencil-square"></i></span></button>
                                        <a href="close-delete.php?id=<?= $close['id']; ?>" class="btn btn-danger btn-sm del"><span><i class="bi bi-trash3-fill"></i></span></a>
                                    </td>
                                </tr>
                                <?php 
                                        }
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Date</span></h4>
...
<div id="editModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Date</span></h4>
                <button type="button" class="close btn btn-danger" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="close-edit.php" method="POST">
