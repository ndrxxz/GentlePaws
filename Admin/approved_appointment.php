        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-black text-white">
                    <h4 class="fw-bold pt-3">Approved Appointments</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-3 py-1">
                                            <div class="button-group">
                                                <a href="completed.php?id=<?= $bookings['id']; ?>" class="btn btn-primary btn-sm completed"><span><i class="bi bi-check2-all"></i></span></a>
                                                <a href="failed.php?id=<?= $bookings['id']; ?>" class="btn btn-danger btn-sm failed"><span><i class="bi bi-x-lg"></i></i></span></a>
                            <!--Download Page--><a href="pdf.php?id=<?= $bookings['id']; ?>" class="btn btn-info btn-sm"><span><i class="bi bi-download"></i></span></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php 
...
<script>
    $(document).ready(function(){
        $('.completed').on('click', function(e) {
            ...
            Swal.fire({
                title : 'Are you sure?',
                text : 'This appointment is completed?',
                icon: 'warning',
...
<script>
    $(document).ready(function(){
        $('.failed').on('click', function(e) {
            ...
            Swal.fire({
                title : 'Are you sure?',
                text : 'This appointment is failed?',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
